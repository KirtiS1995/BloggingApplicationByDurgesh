...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
			return new ApiInfo("Blogging Application : Backend Course", "This project developed by Kirti Salunke", "1.0", "Terms of service", 
									new Contact("Kirti Salunke", "http://kirti21324.com", "kirti.ysalunke@gmail.com"), 
